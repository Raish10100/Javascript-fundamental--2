/*As a web developer,you need to create a function that takes a username string as input and checks if it contain only unique
characters.Use a set to implement this efficiently.*/
